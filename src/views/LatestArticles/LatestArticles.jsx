...
const LatestArticles = () => {
  ...
  if(window.innerWidth <= 650){
    return (
      <div className="latest-articles-mobile">
            <h1>Последние статьи</h1>
        <div className="latest-articles-mobile__blocksmobile">
            <div className="blocks__blockmobile blocks__block1mobile">
              <h2>Генетика</h2>
              <p>
            ...
            <div className="blocks__blockmobile blocks__block2mobile">
              <h2>Нутрициология</h2>
              ...
              <div className="blocks__blockmobile blocks__block3mobile">
                <h2>Кардиология</h2>
                <p>
              ...
              <div className="blocks__blockmobile blocks__block4mobile">
                <h2>Хирургия</h2>
                <p>
              ...
              <div className="blocks__blockmobile blocks__block5mobile">
                <h2>Неврология</h2>
